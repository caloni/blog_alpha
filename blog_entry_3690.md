...
Quando ele explica porque a projeção de filmes não é 3D, mas como seria possível implementar. E de fato já foram feitas várias tentativas de embalar o espectador em um 3D "real" antes dos nossos últimos óculos:
...
Um interessantíssimo experimento com linhas, provando que é a mente humana que completa as lacunas entre duas imagens, imaginando assim o movimento (mesmo que inexistente de forma objetiva no mundo real):
